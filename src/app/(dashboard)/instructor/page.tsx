    ...
    <div className="space-y-12">
      <div className="space-y-4 border-b pb-8">
        <div className="flex items-center gap-2">
          ...
          <span className="text-primary font-bold uppercase tracking-[0.3em] text-[10px]">Gestión Académica</span>
        </div>
        <h2 className="text-5xl font-headline font-black tracking-tighter text-slate-900 leading-none">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        {INSTRUCTOR_COURSES.map((course) => (
          <Card key={course.id} className="group border-none shadow-xl hover:shadow-2xl transition-all bg-white overflow-hidden">
            ...
            <CardHeader className="space-y-4">
              ...
              <div>
                <CardTitle className="text-2xl font-headline font-extrabold group-hover:text-primary transition-colors line-clamp-2">
                  {course.name}
                </CardTitle>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-bold text-slate-700">{course.students} Estudiantes</span>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100">
                <div className="bg-white p-2 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-bold text-slate-700">{course.schedule}</span>
                </div>
              </div>
            </CardContent>
            <CardFooter className="bg-slate-50/50 p-6 gap-3">
              <Button asChild className="flex-1 h-14 font-black text-base shadow-lg shadow-primary/20">
                <Link href={`/instructor/attendance/${course.id}`}>
                  Asistencia <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button 
                variant="outline" 
